...
from api.views import UserCreateView, UserLoginView, GetProfileImageView, VerifyFaceView, DocumentRequestCreateView, DocumentProcessRequestView, DocumentConfirmRequestView, DownloadDocumentView, VerifyEmailView, ResendOtpView
...
urlpatterns = [
    ...
    path('verify_face/', VerifyFaceView.as_view(), name='verify_face'),

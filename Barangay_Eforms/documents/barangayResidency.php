...
<head>
    <meta charset="UTF-8">
    <title>Barangay Residency - Barangay E-Forms</title>
...
<div class="content-container">
    <h1>Barangay Residency Request</h1>

    <form id="docForm" method="POST">
        <input type="hidden" name="document_type" id="document_type" value="residency">
        ...
        <input type="text" name="years" placeholder="e.g. 5 years" required>

        <label>Purpose:</label>
        <textarea name="purpose" placeholder="e.g. Government requirement, enrollment" required></textarea>
